...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="cabeceracampos">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="IdEquipo" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Width="926px"  OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Height="490px">
