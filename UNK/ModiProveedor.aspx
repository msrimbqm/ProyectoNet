<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ModiProveedor.aspx.cs" Inherits="UNK.ModiProveedor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <link href="css/Styles.css" rel="stylesheet" />

     <div class="text-center mt-5" id="cabecera1b">
                 <h1>  UnKeeper <img src="img/gear.png" width="100" height="100"> &nbsp;  &nbsp; &nbsp; MODIFICACION DE PROVEEDOR </h1>
     </div> 
            ...
            <div class="filas">
             ...
             <div class="filas">
                <div class="titulos">
                 ...
                 <div class="controles">
                     <asp:TextBox ID="txtCIF" placeholder="Identficador Fiscal" runat="server" Enabled="False"></asp:TextBox>
                </div>
