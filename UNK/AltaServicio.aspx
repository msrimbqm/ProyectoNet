             ...
             <div class="filas">
              ...
              <div class="filas">
                ...
                <div class="filas">
                 ...
                 <div class="cal">
                      <asp:Calendar ID="calFecha" runat="server"  Width="220px"  OnSelectionChanged="calFecha_SelectionChanged" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#003399" Height="200px">
                ...
                <div class="filas">
                 ...
                 <div class="controles">
                  ...
                  <div class="filas">
                    ...
                    <div class="cal">
                          <asp:Calendar ID="calVencimiento" runat="server" Width="220px" OnSelectionChanged="calVencimiento_SelectionChanged" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#003399" Height="200px">
                              <DayHeaderStyle BackColor="#99CCCC" ForeColor="#336666" Height="1px" />
                              <NextPrevStyle Font-Size="8pt" ForeColor="#CCCCFF" />
                              <OtherMonthDayStyle ForeColor="#999999" />
                              <SelectedDayStyle BackColor="#009999" Font-Bold="True" ForeColor="#CCFF99" />
